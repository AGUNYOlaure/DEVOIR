...
app.config["SQLALCHEMY_DATABASE_URI"] = "sqlite:///" + \
    os.path.join(basedir, "mydatabase.sqlite")
...
# route pour consulter tous les articles
...
# route pour consulter un article par son id
...
@app.route('/')
def home():
    return 'Bienvenue sur l\'API des articles !'
